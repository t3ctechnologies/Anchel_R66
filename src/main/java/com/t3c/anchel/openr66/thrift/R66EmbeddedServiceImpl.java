 ...
 */
package com.t3c.anchel.openr66.thrift;
...
public class R66EmbeddedServiceImpl implements R66Service.Iface {
    ...
    private int stopOrCancelRunner(long id, String reqd, String reqr, com.t3c.anchel.openr66.context.ErrorCode code) {
        try {
    ...
    private R66Result stopOrCancel(R66Request request, LocalChannelReference lcr,
            com.t3c.anchel.openr66.context.ErrorCode r66code) {
        // stop the current transfer
        R66Result resulttest;
        if (lcr != null) {
            int rank = 0;
            if (r66code == com.t3c.anchel.openr66.context.ErrorCode.StoppedTransfer && lcr.getSession() != null) {
    ...
    private R66Result restart(R66Request request, LocalChannelReference lcr) {
        ...
        try {
            ...
            com.t3c.anchel.openr66.context.R66Result resulttest = TransferUtils.restartTransfer(taskRunner, lcr);
    ...
    public R66Result infoTransferQuery(R66Request request) throws TException {
        ...
        switch (request.getAction()) {
            ...
            case Cancel:
                r66code = com.t3c.anchel.openr66.context.ErrorCode.CanceledTransfer;
                return stopOrCancel(request, lcr, r66code);
            case Stop:
                r66code = com.t3c.anchel.openr66.context.ErrorCode.StoppedTransfer;
                return stopOrCancel(request, lcr, r66code);
            default:
