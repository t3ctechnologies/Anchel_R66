 ...
 */
package com.t3c.anchel.openr66.protocol.http.rest;
...
import com.t3c.anchel.openr66.protocol.http.rest.handler.DbConfigurationR66RestMethodHandler;
import com.t3c.anchel.openr66.protocol.http.rest.handler.DbHostAuthR66RestMethodHandler;
import com.t3c.anchel.openr66.protocol.http.rest.handler.DbHostConfigurationR66RestMethodHandler;
import com.t3c.anchel.openr66.protocol.http.rest.handler.DbRuleR66RestMethodHandler;
import com.t3c.anchel.openr66.protocol.http.rest.handler.DbTaskRunnerR66RestMethodHandler;
import com.t3c.anchel.openr66.protocol.http.rest.handler.HttpRestBandwidthR66Handler;
import com.t3c.anchel.openr66.protocol.http.rest.handler.HttpRestBusinessR66Handler;
import com.t3c.anchel.openr66.protocol.http.rest.handler.HttpRestConfigR66Handler;
import com.t3c.anchel.openr66.protocol.http.rest.handler.HttpRestControlR66Handler;
import com.t3c.anchel.openr66.protocol.http.rest.handler.HttpRestInformationR66Handler;
import com.t3c.anchel.openr66.protocol.http.rest.handler.HttpRestLogR66Handler;
import com.t3c.anchel.openr66.protocol.http.rest.handler.HttpRestServerR66Handler;
...
public class HttpRestR66Handler extends HttpRestHandler {
    ...
    public static enum RESTHANDLERS {
        DbHostAuth(DbHostAuthR66RestMethodHandler.BASEURI, com.t3c.anchel.openr66.database.data.DbHostAuth.class),
        DbRule(DbRuleR66RestMethodHandler.BASEURI, com.t3c.anchel.openr66.database.data.DbRule.class),
        DbTaskRunner(DbTaskRunnerR66RestMethodHandler.BASEURI, com.t3c.anchel.openr66.database.data.DbTaskRunner.class),
        DbHostConfiguration(DbHostConfigurationR66RestMethodHandler.BASEURI,
                com.t3c.anchel.openr66.database.data.DbHostConfiguration.class),
        DbConfiguration(DbConfigurationR66RestMethodHandler.BASEURI,
                com.t3c.anchel.openr66.database.data.DbConfiguration.class),
