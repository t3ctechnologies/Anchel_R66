...
public class TransferRequestJsonPacketTest extends JsonPacket {
    ...
    public void testItIsDeserialized() {
        try {
            String json = "{\"requested\": \"server1\", \"@class\": \"com.t3c.anchel.openr66.protocol.localhandler.packet.json.TransferRequestJsonPacket\", \"rulename\": \"send\", \"filename\": \"test.dat\"}";
    ...
    public void testFileInformationShouldBeDeserialized() {
        ...
        try {
            String json = "{\"fileInformation\": \"foo\", \"@class\": \"com.t3c.anchel.openr66.protocol.localhandler.packet.json.TransferRequestJsonPacket\"}";
    ...
    public void testFileInformationShouldNotBeNullAfterDeserialization() {
        ...
        try {
            String json = "{\"@class\": \"com.t3c.anchel.openr66.protocol.localhandler.packet.json.TransferRequestJsonPacket\"}";
            TransferRequestJsonPacket res = new ObjectMapper().readValue(json, TransferRequestJsonPacket.class);
